...
export default async function AdministratorDashboardPage() {
  ...
  if (!userAccount || userAccount.role !== "ADMINISTRATOR") redirect("/dashboard");
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <nav className="mt-3 flex flex-wrap gap-4 text-sm text-blue-600">
          <Link href="/administrator/create-account" className="underline">Create account</Link>
          <Link href="/administrator/accounts" className="underline">Manage accounts</Link>
          <Link href="/administrator/enrollment-import" className="underline">Enrollment import</Link>
          <Link href="/administrator/catalogue" className="underline">Academic catalogue</Link>
          <Link href="/administrator/academic-calendar" className="underline">Academic Calendar</Link>
        </nav>
