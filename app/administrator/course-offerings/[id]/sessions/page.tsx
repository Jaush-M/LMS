    ...
    <main className="p-8 max-w-4xl">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-3">
          <Link href={`/administrator/course-offerings/${id}/sessions/new`} className="rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">
            + Schedule Session
          </Link>
          <Link href={`/administrator/course-offerings/${id}`} className="text-sm text-blue-600 underline self-center">Back</Link>
        </div>
      </div>
