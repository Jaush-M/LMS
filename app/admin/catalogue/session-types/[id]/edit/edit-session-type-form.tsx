...
import { editSessionTypeAction } from "@/lib/actions/catalogue-action";

export function EditSessionTypeForm({ id, defaultName }: { id: string; defaultName: string }) {
  const [state, action, pending] = useActionState(editSessionTypeAction, null);
