...
import { editStudyModeAction } from "@/lib/actions/catalogue-action";

export function EditStudyModeForm({ id, defaultName }: { id: string; defaultName: string }) {
  const [state, action, pending] = useActionState(editStudyModeAction, null);
